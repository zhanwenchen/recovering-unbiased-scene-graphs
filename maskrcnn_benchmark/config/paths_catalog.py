...
class DatasetCatalog(object):
    ...
    def get(name, cfg):
        if "coco" in name:
            ...
            args['stl_train_norm'] = cfg.MODEL.STL_TRAIN_NORM
            args['stl_eval_zero_out_nan'] = cfg.MODEL.STL_EVAL_ZERO_OUT_NAN
            args['vis_mode'] = cfg.MODEL.VIS_MODE

            # CAT
            args['concept_augmented_training'] = cfg.TRAIN.CONCEPT_AUGMENTED
            args['cogtree_path'] = cfg.TRAIN.COGTREE_PATH
